...
$stmt = "select FirstName,LastName from user where Studentid =?";
			...
			<div class="navbar">
				...
				<nav>
					<ul id="menuList">
						...
						<li>
							<div class="dropdown">
								<button class="dropbtn"><?php echo $data['FirstName'] . ' ' . $data['LastName'] ?></button>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-1">
					...
					<h4> </h4>
					<button type="button"><a href="request1.php">Request Now!</a><img src="img/arrow.png"></button>
				</div>
				<div class="col-2">
